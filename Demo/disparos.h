...
struct NAVE
{
    ...
    void inicia(char* ruta_nave, char* ruta_bala, int _ancho_b, int _alto_b, int _ancho_p, int _alto_p, int _x, int _y, int _dir_bala,int _tipo,int vida);
    void pinta(BITMAP* buffer, int ix, int iy);
    bool temporizador(int j);
    void mueve();
